        ...
        <article className="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
            <main className="pa4 black-80">
                <div className="measure">
                    ...
                    <div className="">
                    <input onClick={() => onRouteChange('home')} className="white b ph3 pv2 input-reset ba b--white bg-transparent grow pointer f6 dib hover-bg-black" type="submit" value="Sign in" />
                    </div>
